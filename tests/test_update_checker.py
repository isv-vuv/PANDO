...
class UpdateCheckerTests(unittest.TestCase):
    ...
    @patch("core.app.app_core.update_checker.fetch_github_remote_info", return_value=("", "", ""))
    @patch("core.app.app_core.update_checker.get_git_status")
    def test_check_for_updates_up_to_date(self, mock_status, mock_remote):
    ...
    @patch("core.app.app_core.update_checker.fetch_github_remote_info", return_value=("", "", ""))
    @patch("core.app.app_core.update_checker.get_git_status")
    def test_check_for_updates_newer_commit(self, mock_status, mock_remote):
        mock_status.return_value = {
            "is_git": True,
            "branch": "main",
            "upstream": "origin/main",
    ...
    @patch("core.app.app_core.update_checker.fetch_github_remote_info", return_value=("", "", ""))
    @patch("core.app.app_core.update_checker.get_git_status")
    def test_check_for_updates_missing_files(self, mock_status, mock_remote):
        mock_status.return_value = {
            "is_git": True,
            "branch": "main",
            "upstream": "origin/main",
    ...
    @patch("core.app.app_core.update_checker.fetch_github_remote_info", return_value=("", "", ""))
    @patch("core.app.app_core.update_checker.get_git_status")
    def test_check_for_updates_offline(self, mock_status, mock_remote):
        mock_status.return_value = {
            "is_git": True,
            "branch": "main",
            "upstream": "origin/main",
    ...
    @patch("core.app.app_core.update_checker.fetch_github_remote_info", return_value=("", "", ""))
    @patch("core.app.app_core.update_checker.get_git_status")
    def test_check_for_updates_local_modifications(self, mock_status, mock_remote):
        mock_status.return_value = {
            "is_git": True,
            "branch": "main",
            "upstream": "origin/main",
            ...
            "ahead_count": 0,
            "deleted_files": [],
            "modified_files": ["core/locales/de.json"],
            "fetch_ok": True,
            "local_commit": "abc123456789",
            "remote_commit": "abc123456789",
        }
        ...
        self.assertFalse(res.has_update)
        self.assertEqual(res.status_code, "UP_TO_DATE")
        self.assertIn("1 Datei(en) lokal angepasst", res.message)

    @patch("core.app.app_core.update_checker.fetch_github_remote_info", return_value=("", "", ""))
    @patch("core.app.app_core.update_checker.get_git_status")
    def test_check_for_updates_ahead_count(self, mock_status, mock_remote):
        mock_status.return_value = {
            "is_git": True,
            "branch": "main",
            "upstream": "origin/main",
        ...
        self.assertFalse(res.has_update)
        self.assertEqual(res.status_code, "UP_TO_DATE")
        self.assertIn("2 Commit(s) voraus", res.message)
