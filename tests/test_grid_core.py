...
class GridCoreTests(unittest.TestCase):
    ...
    def test_oa_mode_and_adm2_layer_structure(self):
        ...
        widget._saved_step2_data = {"country_codes": ["DEU", "AUT"]}
        widget._saved_step3_data = {}
        widget.selected_location = None
        self.assertEqual(widget._get_selected_country_codes(), ["DEU", "AUT"])
    @requires_geo_dependencies
