...
class AppStateTests(unittest.TestCase):
    def test_step_progress_maps_current_step_to_percent(self):
        ...
        self.assertEqual(progress_percent_for_step(StepId.PROJECT_PBF), 33)
        self.assertEqual(progress_percent_for_step(StepId.GRID_AREA), 50)
    ...
    def test_previous_step_id_walks_back_without_mutating_state(self):
        ...
        self.assertEqual(previous_step_id(StepId.PROCESSING), StepId.GRID_AREA)
        self.assertEqual(previous_step_id(StepId.GRID_AREA), StepId.PROJECT_PBF)
        self.assertEqual(previous_step_id(state.current_step), StepId.SEARCH)
    ...
    def test_step3_payload_contract_is_validated_and_copied(self):
        ...
        self.assertEqual(state.step3_data["cell_size_m"], 3500)
    ...
    def test_step4_payload_contract_preserves_step3_subset(self):
        ...
        self.assertEqual(state.current_step, StepId.GRID_AREA)
