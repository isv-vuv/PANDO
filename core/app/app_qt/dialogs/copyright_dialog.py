...
class CopyrightDialog(_Q_DIALOG_BASE):
    ...
    def _build_ui(self) -> None:
        ...
        header_title.setFont(app_font(13, qfont_bold()))
        ...
        header_info.setStyleSheet("color: #475569;")
        ...
        self.master_checkbox.setFont(app_font(10, qfont_bold()))
        self.master_checkbox.setStyleSheet("color: #0f172a; padding: 2px 0;")
        ...
        self.status_label.setFont(app_font(9))
        ...
        self.cancel_button.setStyleSheet(
            "QPushButton { background-color: #ffffff; color: #334155; border: 1px solid #cbd5e1; border-radius: 4px; padding: 6px 16px; } "
        ...
        self.accept_all_button.setFont(app_font(10, qfont_bold()))
        self.accept_all_button.setStyleSheet(
    ...
    def _create_source_page(self, src: dict) -> QtWidgets.QWidget:
        ...
        title_label.setFont(app_font(10, qfont_bold()))
        title_label.setStyleSheet("color: #334155;")
