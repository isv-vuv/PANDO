...
class Step6ResultsWidget(_Q_WIDGET_BASE):
    ...
    def _setup_ui(self) -> None:
        ...
        self.btn_open_all_qgis = QtWidgets.QPushButton(self.localizer.get_string("step6_btn_open_all_qgis", default="🗺️ Alle Layer in QGIS öffnen"), self)
        ...
        self.btn_open_visum_dir = QtWidgets.QPushButton(self.localizer.get_string("step6_btn_open_visum_dir", default="📁 Visum-Projektordner öffnen"), self)
    ...
    def _build_cards(self) -> None:
        ...
        self.scroll_layout.addWidget(
            ResultCardWidget(
                ...
                description=self.localizer.get_string("step6_layer_census_desc", default="100 m × 100 m Zensusraster für den gesamten Modellraum, korrigiert durch OSM-Siedlungsflächen und optionale Referenzdaten."),
        ...
        self.scroll_layout.addWidget(
            ResultCardWidget(
                title=self.localizer.get_string("step6_layer_urban_centrality_title", default="Innergemeindliche Zentralitäten und Intensitätsschätzung (Modell 5)"),
                description=self.localizer.get_string("step6_layer_urban_centrality_desc", default="Flächenhafte Intensitätsschätzung nach Funktionsbereichen (Heatmap), POI-Standorte sowie Planungs- und Einflussräume (PA, IA1, IA2) als Verkehrszellen und diskrete Zentralitätspunkte."),
