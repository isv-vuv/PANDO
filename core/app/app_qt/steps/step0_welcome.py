...
class Step0WelcomeWidget(_Q_WIDGET_BASE):
    ...
    def _build_ui(self) -> None:
        ...
        steps_data = [
            ...
            _clean_title(self.localizer.get_string("step4_title"), 2),
            _clean_title(self.localizer.get_string("step3_title"), 3),
            _clean_title(self.localizer.get_string("step5_title"), 4),
            _clean_title(self.localizer.get_string("step6_title"), 5),
            _clean_title(self.localizer.get_string("step7_title"), 6),
        ]
