...
class AppState:
    ...
    def create_new_project(
        ...
        self.last_saved_step = StepId.GRID_AREA if selected_location is not None else StepId.SEARCH
    ...
    def set_step3_data(self, data: dict[str, Any]) -> None:
        self._require_keys(data, STEP3_REQUIRED_KEYS, "Step 3")
    ...
    def set_step4_data(self, data: dict[str, Any]) -> None:
        self._require_keys(data, STEP4_REQUIRED_KEYS, "Step 4")
        self.step4_data = dict(data)
        self.step3_data = {key: self.step4_data[key] for key in STEP3_REQUIRED_KEYS}
    ...
    def payload_for_step4(self) -> dict[str, Any]:
        self._require_keys(self.step3_data, STEP3_REQUIRED_KEYS, "Step 3")
        payload = dict(self.step3_data)
    ...
    def payload_for_step5(self) -> dict[str, Any]:
        self._require_keys(self.step4_data, STEP4_REQUIRED_KEYS, "Step 4")
        return dict(self.step4_data)
