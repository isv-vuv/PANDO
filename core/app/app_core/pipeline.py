...
def prepare_project_inputs(project_path: str, step_data: Mapping[str, object]) -> PreparedInputs:
    ...
    alpha2 = get_alpha2_code(location)
    country = pycountry.countries.get(alpha_2=alpha2)
    iso3 = country.alpha_3 if country else alpha2
    (input_dir / "country_code.txt").write_text(iso3, encoding="utf-8")
    ...
    return PreparedInputs(local_crs, center_path, zone_path, pa_poly, extent, grid_size, iso3)
