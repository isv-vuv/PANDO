...
<qgis version="3.40.5-Bratislava" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  <renderer-v2 type="singleSymbol" forceraster="0" symbollevels="0" enableorderby="0">
    <symbols>
      <symbol type="fill" name="0" clip_to_extent="1" alpha="1" force_rhr="0" is_animated="0">
